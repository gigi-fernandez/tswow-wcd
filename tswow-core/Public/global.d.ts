...
declare const enum PlayerSpellState /**@realType:uint8*/ {
    UNCHANGED = 0,
    CHANGED   = 1,
    NEW       = 2,
    REMOVED   = 3,
...
declare const enum AuraRemoveMode /**@realType:uint8*/ {
    NONE = 0,
...
declare const enum SpellState /**@realType:uint32*/ {
    NULL      = 0,
    PREPARING = 1,
    CASTING   = 2,
    FINISHED  = 3,
...
declare interface TSUnit extends TSWorldObject {
    ...
    */
    ...
    /**
     * Adds a movement flag to the unit
     * @param flag The movement flag to add
     */
    AddMovementFlag(flag: uint32): void;

    /**
     * Removes a movement flag from the unit
     * @param flag The movement flag to remove
     */
    RemoveMovementFlag(flag: uint32): void;

    /**
     * Checks if the unit has a specific movement flag
     * @param flag The movement flag to check for
     * @return True if the unit has the flag, false otherwise
     */
    HasMovementFlag(flag: uint32): bool;

    /**
     * Gets all movement flags currently applied to the unit
     * @return The current movement flags as a bitmask
     */
    GetMovementFlags(): TSNumber<uint32>;

    /**
     * Sets all movement flags for the unit
     * @param flags The movement flags to set as a bitmask
     */
    SetMovementFlags(flags: uint32): void;

    /**
     * Adds an extra movement flag to the unit
     * @param flag The extra movement flag to add
     */
    AddExtraMovementFlag(flag: uint32): void;

    /**
     * Removes an extra movement flag from the unit
     * @param flag The extra movement flag to remove
     */
    RemoveExtraMovementFlag(flag: uint32): void;

    /**
     * Checks if the unit has a specific extra movement flag
     * @param flag The extra movement flag to check for
     * @return True if the unit has the flag, false otherwise
     */
    HasExtraMovementFlag(flag: uint32): bool;

    /**
     * Gets all extra movement flags currently applied to the unit
     * @return The current extra movement flags as a bitmask
     */
    GetExtraMovementFlags(): TSNumber<uint32>;

    /**
     * Sets all extra movement flags for the unit
     * @param flags The extra movement flags to set as a bitmask
     */
    SetExtraMovementFlags(flags: uint32): void;
    ...
    /**
     * Checks if the unit is currently turning
     * @return True if the unit is turning, false otherwise
     */
    IsTurning(): bool;

    /**
     * Checks if the unit is capable of flying
     * @return True if the unit can fly, false otherwise
     */
    CanFly(): bool;

    /**
     * Checks if the unit is currently flying
     * @return True if the unit is flying, false otherwise
     */
    IsFlying(): bool;

    /**
     * Checks if the unit can enter water
     * @return True if the unit can enter water, false otherwise
     */
    CanEnterWater(): bool;

    /**
     * Gets the unit's hover height offset
     * @return The hover height offset value
     */
    GetHoverOffset(): TSNumber<float>;

    /**
     * Gets the unit's pitch (vertical orientation)
